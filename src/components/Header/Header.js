...
import { getOrganizationsList, setActiveOrganization } from '../../store/persistedState'
...
const organizationsSelector = createSelector(s => s.persistedState.organization_list, s => s,
  (list, state) => {
...
const currentOrgSelector = createSelector(organizationsSelector, s => s.persistedState.organization_id,
